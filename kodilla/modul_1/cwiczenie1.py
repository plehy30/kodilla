...
for i in text:
    if i == "a":
        ...
        number_of_y += 1
print("a występuje: ", number_of_a, " razy\n"
      "e występuje: ", number_of_e, " razy\n"
      "i występuje: ", number_of_i, " razy\n"
      "o występuje: ", number_of_o, " razy\n"
      "u występuje: ", number_of_u, " razy\n"
      "y występuje: ", number_of_y, " razy\n")
